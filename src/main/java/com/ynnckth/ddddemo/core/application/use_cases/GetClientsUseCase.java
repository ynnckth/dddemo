...
@Service
public class GetClientsUseCase implements GetClients {

    private final ClientsRepository clientsRepository;
    private final ExchangeRatesRepository exchangeRatesRepository;

    public GetClientsUseCase(ClientsRepository clientsRepository, ExchangeRatesRepository exchangeRatesRepository) {
        this.clientsRepository = clientsRepository;
        this.exchangeRatesRepository = exchangeRatesRepository;
    }

    @Override
    public List<Client> invoke(Currency targetCurrency, LocalDate exchangeRateDate) {
